            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    ...
                    <div class="footer-menu-wrap mt-2">
                        <h4 class="mb-3">Our Website Stats </h4>

                        <ul class="list-unstyled">
                            <li> Total Jobs:  {{ DB::table('jobs')->count() }}</li>
                            <li>  Total Job Seekers : {{ DB::table('users')->where('user_type',  'user')->count() }} </li>
                            <li> Total Employer : {{ DB::table('users')->where('user_type',  'employer')->count() }} </li>
                        </ul>
