        ...
        <nav class="navbar navbar-expand-md navbar-light navbar-laravel">
            <div class="container-fluid">
                <a class="navbar-brand" href="{{ route('dashboard') }}">
                    <img src="{{asset('https://www.google.com.bd/url?sa=i&source=images&cd=&ved=2ahUKEwiRxMSIid_mAhW1yTgGHQqDBmEQjRx6BAgBEAQ&url=https%3A%2F%2Fallied-paper.co.uk%2Fbusiness-services%2Fjobs-in-sri-lanka.html&psig=AOvVaw0Pgf8EShsFCuAsD3FAN6lJ&ust=1577853616288015')}}" height="200px" />
                </a>
                    ...
                    <div class="sidebar">
                        <ul class="sidebar-menu list-group list-unstyled">
                            ...
                            <li class="{{request()->is('dashboard')? 'active' : ''}}">
                             ...
                             @if(  $user->is_user())
                            <li class="">
                                <a href="{{URL::to('/dashboard/view/resume')}}" class="list-group-item-action active">
                                    <span class="sidebar-icon"><i class="la la-list-alt"></i> </span>
                                    <span class="title">View Resume</span>
                                </a>
                            </li>
                            <li class="">
                            ...
                            <li class="#">
                                <a href="{{URL::to('/add/gender') }}" class="list-group-item-action active">
                                    <span class="sidebar-icon"><i class="la la-th-large"></i> </span>
                                    <span class="title"> Gender Categories</span>
                                </a>
                            </li>
                            <li class="#">
                                <a href="{{URL::to('/add/marital/status') }}" class="list-group-item-action active">
                                    <span class="sidebar-icon"><i class="la la-th-large"></i> </span>
                                    <span class="title"> Ad Marital Status</span>
                                </a>
                            </li>

                            <li class="#">
                                <a href="{{URL::to('/add/education/categories') }}" class="list-group-item-action active">
                                    <span class="sidebar-icon"><i class="la la-th-large"></i> </span>
                                    <span class="title"> Education Category </span>
                                </a>
                            </li>
